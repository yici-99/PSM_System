...
<form action="searchSTrubric" method="post">
    @csrf
    <b>
<select name="rubricType"  style="margin-left:2%;width:20%;border-radius:6px;font-size:20px;height:20%;font-family:Rockwell;background:#EDE6D6;border-width:3px;border-color:black;">
    ...
    <option value="STU_PSM1" name="rubricType">PSM1</option>
    <option value="STU_PSM2" name="rubricType">PSM2</option>
    <option value="STU_PTA" name="rubricType">PTA</option>    
    </select>
</b>
